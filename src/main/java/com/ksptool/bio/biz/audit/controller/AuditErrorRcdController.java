...
import com.ksptool.bio.biz.audit.modal.auditerrorrcd.dto.GetAuditErrorRcdListDto;
import com.ksptool.bio.biz.audit.modal.auditerrorrcd.vo.GetAuditErrorRcdDetailsVo;
import com.ksptool.bio.biz.audit.modal.auditerrorrcd.vo.GetAuditErrorRcdListVo;
...
@Tag(name = "系统错误记录管理", description = "系统错误记录管理")
@Slf4j
