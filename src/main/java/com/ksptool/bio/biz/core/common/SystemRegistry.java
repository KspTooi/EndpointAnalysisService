...
public enum SystemRegistry {
    ...
    SystemRegistry(String key, String value, NvalueKind nvalueKind, String label) {
        this(key, value, nvalueKind, label, null);
    }

    SystemRegistry(String key, String value, NvalueKind nvalueKind, String label, String remark) {
        this.key = key;
        this.value = value;
