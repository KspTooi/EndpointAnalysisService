...
CREATE TABLE `auth_group`  (
                               ...
                               `code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组标识，如：admin、developer等',
                               `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组名称，如：管理员组、开发者组等',
                               `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '组描述',
...
-- ----------------------------
-- Table structure for auth_group_dept
-- ----------------------------
...
CREATE TABLE `auth_group_dept`  (
                                    ...
                                    `create_time` datetime NOT NULL COMMENT '创建时间',
                                    PRIMARY KEY (`group_id`, `dept_id`) USING BTREE,
                                    UNIQUE INDEX `group_id`(`group_id` ASC, `dept_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'GD表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auth_group_permission`  (
                                          ...
                                          UNIQUE INDEX `group_id`(`group_id` ASC, `permission_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'GP表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auth_permission`  (
                                    ...
                                    `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限名称，如：查看用户',
                                    `code` varchar(320) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限标识，如：system:user:view',
                                    `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '权限描述',
                                    `seq` int NOT NULL COMMENT '排序号',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限码表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auth_user_group`  (
                                    ...
                                    UNIQUE INDEX `user_id`(`user_id` ASC, `group_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'UG表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auth_user_session`  (
                                      ...
                                      `session_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户凭据',
...
-- ----------------------------
-- Table structure for core_app_status_rcd
-- ----------------------------
DROP TABLE IF EXISTS `core_app_status_rcd`;
CREATE TABLE `core_app_status_rcd`  (
                                        `id` bigint NOT NULL COMMENT '主键ID',
                                        `cpu_usage` decimal(5, 2) NULL DEFAULT NULL COMMENT 'CPU使用率(%)',
                                        `mem_usage` decimal(5, 2) NULL DEFAULT NULL COMMENT '内存使用率(%)',
                                        `jvm_usage` decimal(5, 2) NULL DEFAULT NULL COMMENT 'JVM使用率(%)',
                                        `load_average` decimal(5, 2) NULL DEFAULT NULL COMMENT '系统1分钟平均负载',
                                        `net_snd_bytes` bigint NULL DEFAULT NULL COMMENT '网络每秒发送(Bytes/s)',
                                        `net_rcv_bytes` bigint NULL DEFAULT NULL COMMENT '网络每秒接收(Bytes/s)',
                                        `create_time` datetime NOT NULL COMMENT '记录时间',
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '核心域-应用性能监控记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `core_notice`  (
                                `id` bigint NOT NULL COMMENT '主键ID',
                                `title` varchar(320) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标题',
...
CREATE TABLE `core_post`  (
                              ...
                              `delete_time` datetime NULL DEFAULT NULL COMMENT '删除时间 NULL未删',
                              PRIMARY KEY (`id`) USING BTREE,
                              UNIQUE INDEX `code`(`code` ASC, `delete_time` ASC) USING BTREE
...
CREATE TABLE `core_user`  (
                              ...
                              `username` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名',
                              `password` varchar(1280) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码',
                              ...
                              `phone` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号码',
                              ...
                              `root_id` bigint NULL DEFAULT NULL COMMENT '所属企业ID',
                              `root_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属企业名称',
                              `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
                              `dept_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门名称',
                              `active_company_id` bigint NULL DEFAULT NULL COMMENT '已激活的公司ID(兼容字段)',
                              `active_env_id` bigint NULL DEFAULT NULL COMMENT '已激活的环境ID(兼容字段)',
...
CREATE TABLE `drive_entry`  (
                                ...
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '云盘实体' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for drive_space
-- ----------------------------
...
CREATE TABLE `drive_space`  (
                                ...
                                `root_id` bigint NOT NULL COMMENT '租户ID',
                                `dept_id` bigint NOT NULL COMMENT '部门ID',
                                `name` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '空间名称',
                                `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '空间描述',
                                ...
                                `delete_time` datetime NULL DEFAULT NULL COMMENT '删除时间 为NULL未删除',
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '云盘空间' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for drive_space_member
-- ----------------------------
...
CREATE TABLE `drive_space_member`  (
                                       ...
                                       `updater_id` bigint NOT NULL COMMENT '更新人',
                                       PRIMARY KEY (`id`) USING BTREE,
                                       UNIQUE INDEX `uk_space_member`(`drive_space_id` ASC, `member_kind` ASC, `member_id` ASC) USING BTREE,
                                       INDEX `idx_member`(`member_kind` ASC, `member_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '云盘空间成员' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 206643 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '重放请求' ROW_FORMAT = DYNAMIC;
...
DELETE FROM core_registry;

-- 插入基本表数据
INSERT INTO `core_user` (`id`, `username`, `password`, `nickname`, `gender`, `phone`, `email`, `login_count`, `status`, `last_login_time`, `root_id`, `root_name`, `dept_id`, `dept_name`, `active_company_id`, `active_env_id`, `avatar_attach_id`, `is_system`, `data_version`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1339890159700807681, 'admin', '$2a$10$yJ3SHJefImsog8W8psyZqOxqp3Mp0SKYZz8xT4wbKgxxupyzSQGEy', '平台管理员', 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2025-08-11 09:29:13', 0, '2026-02-09 04:33:16', 0, NULL);
INSERT INTO `auth_group` (`id`, `code`, `name`, `remark`, `status`, `seq`, `row_scope`, `is_system`, `create_time`, `creator_id`, `update_time`, `updater_id`) VALUES (1339890159700807680, 'admin', '管理员组', '管理员组', 1, 1, 0, 0, '2026-02-14 17:25:08', 0, '2026-02-24 19:52:50', 0);
INSERT INTO `auth_user_group` (`user_id`, `group_id`) VALUES (1339890159700807681, 1339890159700807680);
INSERT INTO `auth_permission` (`id`, `name`, `code`, `remark`, `seq`, `is_system`, `create_time`, `creator_id`, `update_time`, `updater_id`) VALUES (1339890150829854722, '超级权限', '*:*:*', '拥有此权限的用户组不受任何权限限制', 0, 1, '2026-02-14 17:25:06', 0, '2026-02-14 17:25:06', 0);
INSERT INTO `auth_group_permission` (`group_id`, `permission_id`) VALUES (1339890159700807680,1339890150829854722);

-- 插入关键注册表数据

-- 注册表节点config
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1337906113718390784, NULL, 'config', 0, 'config', NULL, NULL, '应用配置', NULL, NULL, 0, 0, 0, '2026-02-09 06:01:15', 0, '2026-02-09 06:01:15', 0, NULL);
-- 注册表节点config.main
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1337907982813499392, 1337906113718390784, 'config.main', 0, 'main', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '2026-02-09 06:08:40', 0, '2026-02-09 06:08:40', 0, NULL);
-- 注册表节点config.install_wizard
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1337906400193548288, 1337906113718390784, 'config.install_wizard', 0, 'install_wizard', NULL, NULL, '安装向导', NULL, NULL, 0, 0, 1, '2026-02-09 06:02:23', 0, '2026-02-09 06:08:43', 0, NULL);
-- 注册表CM值 config.main
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1337908050077552640, 1337907982813499392, 'config.main.version', 1, 'version', 0, '1.0A', '应用程序版本', NULL, '{}', NULL, 0, 0, '2026-02-09 06:08:56', 0, '2026-03-01 05:03:31', 0, NULL);
-- 注册表CI值 config.install_wizard
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1337906695518687232, 1337906400193548288, 'config.install_wizard.enabled', 1, 'enabled', 1, '0', '启用向导模式', '是否为向导模式 0:否 1:是', '{}', NULL, 0, 0, '2026-02-09 06:03:33', 0, '2026-03-01 05:03:31', 0, NULL);
INSERT INTO `core_registry` (`id`, `parent_id`, `key_path`, `kind`, `nkey`, `nvalue_kind`, `nvalue`, `label`, `remark`, `metadata`, `is_system`, `status`, `seq`, `create_time`, `creator_id`, `update_time`, `updater_id`, `delete_time`) VALUES (1343655905362841600, 1337906400193548288, 'config.install_wizard.allow_upgrade', 1, 'allow_upgrade', 1, '1', '版本落后时自动触发安装向导 0:否 1:是' , NULL, '{}', 0, 0, 0, '2026-02-25 02:48:52', 0, '2026-03-01 03:49:09', 0, NULL);
-- 插入FLYWAY基线版本
INSERT INTO `flyway_schema_history` (`installed_rank`, `version`, `description`, `type`, `script`, `checksum`, `installed_by`, `installed_on`, `execution_time`, `success`) VALUES (1, '1.6.1359', 'BaseLine1.6M59', 'BASELINE', 'BaseLine1.6M59', NULL, 'root', '2026-03-01 16:06:12', 0, 1);
