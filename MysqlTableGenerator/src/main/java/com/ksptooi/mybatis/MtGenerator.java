package com.ksptooi.mybatis;

import com.ksptooi.mybatis.autoconfig.*;
import com.ksptooi.mybatis.generator.*;
...
public class MtGenerator {
    ...
    private final GeneratorDataSource dataSource;
    private final MtgGenOptions config;
    ...
    public MtGenerator(GeneratorDataSource ds, MtgGenOptions config){
        this.dataSource = ds;
        this.config = config;
    ...
    private void initDefaultGenerators(){
        if(generators.isEmpty()){
            ...
            generators.add(new GeneratorEntitiesWithDto());
        }

        //添加额外的自动生成类
        generators.addAll(config.getGenerators());
    ...
    public void generate() {
        ...
        try {
            ...
            List<TableField> fields = dbt.getFieldsByTable(null,config.getTableName());
