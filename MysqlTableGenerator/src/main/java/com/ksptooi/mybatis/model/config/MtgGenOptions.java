package com.ksptooi.mybatis.model.config;
...
public class MtgGenOptions {
    ...
    public String getPkgNameDto() {
        return pkgNameDto;
    }

    public void setPkgNameDto(String pkgNameDto) {
        this.pkgNameDto = pkgNameDto;
    }
