...
public class VelocityWrapper {
    ...
    public static VelocityContext injectContext(MtgGenOptions opt, List<TableField> fields){
        ...
        v.put("pkgNameDto", opt.getPkgNameDto());
        ...
        v.put("requestMapping", TextConv.toJavaFiled(opt.getControllerName().replace("Controller","")));
        ...
        v.put("fieldDtoName", TextConv.toJavaFiled(opt.getDtoName()));
