...
public class DictVelocityWrapper {

    private static final Logger log = LoggerFactory.getLogger(DictVelocityWrapper.class);

    private static VelocityEngine ve = null;

    private static String namespace = null;

    private static DictGenOptions opt = null;

    public static void init(String path, DictGenOptions opt){
     ...
     * @return
     */
    public static VelocityContext injectContext(){
