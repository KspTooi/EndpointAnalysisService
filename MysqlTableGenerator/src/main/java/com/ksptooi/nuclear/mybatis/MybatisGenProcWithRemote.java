...
public class MybatisGenProcWithRemote extends OptionRegister {

    private static final Logger log = LoggerFactory.getLogger(MybatisGenProcWithRemote.class);

    public MybatisGenProcWithRemote() {
    ...
    public void process(DataSource ds, Artifact a) {
        ...
        var fileMapper = new File(unionFile(parentClasses,pkgMapper,nameMapper+".java"));
        var fileXml = new File(unionFile(parentXml,nameMapper+".xml"));
        ...
        var fileVoList = new File(unionFile(parentClasses,pkgVo,businessClassName+"PageVo.java"));
        var fileVoGet = new File(unionFile(parentClasses,pkgVo,businessClassName+"DetailsVo.java"));

        var fileDto = new File(unionFile(parentClasses,pkgDto,nameDto+".java"));
        var fileDtoList = new File(unionFile(parentClasses,pkgDto,businessClassName+"PageDto.java"));
