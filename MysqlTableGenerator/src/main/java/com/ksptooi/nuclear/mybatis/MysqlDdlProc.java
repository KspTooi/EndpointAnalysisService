 ...
 */
public class MysqlDdlProc extends OptionRegister {


    private static final Logger log = LoggerFactory.getLogger(MysqlDdlProc.class);
    ...
    public void process(DataSource ds, Artifact a) {
        ...
        DatabaseTools dbt = new DatabaseTools((Connection) ds.getRaw());
