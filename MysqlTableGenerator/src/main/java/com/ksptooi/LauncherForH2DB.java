...
public class LauncherForH2DB {
    ...
    public static void main(String[] args) {
        ...
        // 根据表结构生成CRUD
        generateJpaCrud("SIMPLE_FILTER", "ksptooi");
        generateJpaCrud("SIMPLE_FILTER_OPERATION", "ksptooi");
        generateJpaCrud("SIMPLE_FILTER_TRIGGER", "ksptooi");
//        generateJpaCrud("sys_tag_rel", "ksptooi");
    }
    ...
    private static void generateJpaCrud(String tableName, String author) {
        ...
        var ds = new H2DataSource();
        ds.set("driver", "org.h2.Driver");
        ds.set("host", "127.0.0.1:59000");
        ds.set("username", "");
        ds.set("password", "");
        ds.set("params", "");
        ds.set("dbName", "EndpointAnalysisService");

        // DDL解析器 用于将MYSQL表转换为Mybatis生成器需要的数据格式
        var ddlProc = new H2DdlProc();
